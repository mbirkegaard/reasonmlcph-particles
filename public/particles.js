...
var Caml_format              = __webpack_require__(5);
var Caml_string              = __webpack_require__(3);
var Caml_exceptions          = __webpack_require__(10);
var Caml_missing_polyfill    = __webpack_require__(16);
var Caml_builtin_exceptions  = __webpack_require__(0);
...
var Caml_int64              = __webpack_require__(9);
...
function vector2radians(vector) {
  var match = normalise(vector);
  return Math.atan2(match[1], match[0]);
}

function randomUnit($staropt$star, $staropt$star$1, _) {
  var first = $staropt$star ? $staropt$star[0] : 0.0;
  var second = $staropt$star$1 ? $staropt$star$1[0] : 2 * Math.PI;
  var diff = second - first;
  return unitVector(first + Random.$$float(diff));
}
...
exports.vector2radians = vector2radians;
...
var Curry                   = __webpack_require__(1);
var Int32                   = __webpack_require__(26);
var Int64                   = __webpack_require__(27);
var Digest                  = __webpack_require__(28);
var Caml_sys                = __webpack_require__(14);
...
var Vector2$ReasonmlcphParticles = __webpack_require__(11);

var pi = (Math.PI);

function getContext(canvas, contextType) {
  if (contextType >= 247037478) {
...
function drawVector(context, origin, vector) {
  var match = Vector2$ReasonmlcphParticles.add(origin, vector);
  return drawLine(context, origin[0], origin[1], match[0], match[1]);
}

function drawCircle(context, $staropt$star, $staropt$star$1, param, radius) {
  var colour = $staropt$star ? $staropt$star[0] : /* tuple */[
      0,
      0,
      0
    ];
  var alpha = $staropt$star$1 ? $staropt$star$1[0] : 1.0;
  context.beginPath();
  context.fillStyle = "rgba(" + (String(colour[0]) + (", " + (String(colour[1]) + (", " + (String(colour[2]) + (", " + (String(alpha) + ")")))))));
  context.arc(param[0], param[1], radius, 0, 2 * pi, /* false */0);
  context.fill();
  return /* () */0;
}
...
var Random                        = __webpack_require__(17);
var Canvas$ReasonmlcphParticles   = __webpack_require__(19);
var Vector2$ReasonmlcphParticles  = __webpack_require__(11);
var Particle$ReasonmlcphParticles = __webpack_require__(33);
...
var context = Canvas$ReasonmlcphParticles.getContext(canvas, /* twoD */-855151304);

var width = canvas.width;

var height = canvas.height;

var center_000 = width / 2;

var center_001 = height / 2;
...
var gravity = Vector2$ReasonmlcphParticles.mul(Vector2$ReasonmlcphParticles.down, 0.01);

var state = [/* [] */0];

function update(msg, state) {
  if (msg) {
    var colour_000 = Random.$$int(256);
    var colour_001 = Random.$$int(256);
    var colour_002 = Random.$$int(256);
    var colour = /* tuple */[
      colour_000,
      colour_001,
      colour_002
    ...
    return /* :: */[
            Particle$ReasonmlcphParticles.make(msg[0], msg[1], colour),
            state
          ];
  } else {
    return List.map((function (param) {
                  return Particle$ReasonmlcphParticles.update(gravity, param);
                }), state);
  }
}

function draw(state) {
  Canvas$ReasonmlcphParticles.clearCanvas(canvas, context);
  return List.iter((function (param) {
                return Particle$ReasonmlcphParticles.draw(context, param);
              }), state);
}

function dispatch(msg) {
  var newState = update(msg, state[0]);
  state[0] = newState;
  return draw(state[0]);
}
...
setInterval((function () {
        return dispatch(/* SpawnParticle */[
                    center,
                    Vector2$ReasonmlcphParticles.randomUnit(/* None */0, /* None */0, /* () */0)
                  ]);
      }), 10);
...
function make(position, velocity, colour) {
  return /* record */[
          /* position */position,
          /* velocity */velocity,
          /* colour */colour
...
function draw(context, param) {
  return Canvas$ReasonmlcphParticles.drawCircle(context, /* Some */[param[/* colour */2]], /* None */0, param[/* position */0], 2.0);
}

function update(acceleration, particle) {
  var newVelocity = Vector2$ReasonmlcphParticles.add(particle[/* velocity */1], acceleration);
  return /* record */[
          /* position */Vector2$ReasonmlcphParticles.add(particle[/* position */0], newVelocity),
          /* velocity */newVelocity,
          /* colour */particle[/* colour */2]
        ];
}
...
exports.draw   = draw;
exports.update = update;
/* Canvas-ReasonmlcphParticles Not a pure module */
